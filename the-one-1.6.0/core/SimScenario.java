...
public class SimScenario implements Serializable {
	...
	private static final String APP_PACKAGE = "applications.";
        ...
        private static final String COOPFACTOR = "coopFactor";
	...
	protected void createHosts() {
		this.hosts = new ArrayList<DTNHost>();
                this.observer = new ArrayList<DTNHost>();
		...
		for (int i=1; i<=nrofGroups; i++) {
			...
			for (int j=0; j<nrofHosts; j++) {
				...
				hosts.add(host);
                                if(gid.equalsIgnoreCase("Observer")){
                                    observer.add(host);
                                }
			}
		}
	...
	public List<DTNHost> getHosts() {
        ...
        public List<DTNHost> getObserver(){
            return observer;
        }
